...
public partial class JSValueConverter
{
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,TResult>, fromJSFunction<T1,TResult>);
        }
...
JavaScriptValue p2 = ToJSValue<T2>(context,para2);
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,T2,TResult>, fromJSFunction<T1,T2,TResult>);
        }
...
JavaScriptValue p3 = ToJSValue<T3>(context,para3);
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,T2,T3,TResult>, fromJSFunction<T1,T2,T3,TResult>);
        }
...
JavaScriptValue p4 = ToJSValue<T4>(context,para4);
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,T2,T3,T4,TResult>, fromJSFunction<T1,T2,T3,T4,TResult>);
        }
...
JavaScriptValue p5 = ToJSValue<T5>(context,para5);
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,T2,T3,T4,T5,TResult>, fromJSFunction<T1,T2,T3,T4,T5,TResult>);
        }
...
JavaScriptValue p6 = ToJSValue<T6>(context,para6);
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,T2,T3,T4,T5,T6,TResult>, fromJSFunction<T1,T2,T3,T4,T5,T6,TResult>);
        }
...
JavaScriptValue p7 = ToJSValue<T7>(context,para7);
        ...
        {
            RegisterConverter<Func<bool,TResult>>(toJSFunction<T1,T2,T3,T4,T5,T6,T7,TResult>, fromJSFunction<T1,T2,T3,T4,T5,T6,T7,TResult>);
        }
