...
The next step is to add "Module" support, that will be the last piece of this library. After that I will continue my E-Paper project which is the first consumer of this library, Then I will come back and work on samples and documents stuff.
