namespace JSModuleTest.API
{
...

    {
        ...
        [DllImport(DllName, EntryPoint = "JsSetModuleHostInfo")]
        public static extern JavaScriptErrorCode JsSetFetchImportedModuleCallback(JavaScriptModuleRecord module, JavascriptModuleHostInfoKind kind, FetchImportedModuleDelegate value);
